...
```
$ git clone https://github.com/hiof/colors.git
```
...
`$ grunt build`: Compiles and builds the colors plugin
...
[Github releases](https://github.com/hiof/colors/releases)

### Roadmap

v1.0.0 - Initial colors
